...
export function Admin() {
      ...
      (t) => (
        <div className="flex flex-col gap-2">
          <p className="font-medium">
            Are you sure you want to revoke access for {address.slice(0, 10)}...?
          </p>
  ...
  const stats = [
    { label: 'Total Users', value: users.length, icon: Users, color: 'blue' },
    {
      ...
      value: users.filter((u) => !u.approved && u.requestedRole !== 0).length,
      icon: Clock,
      color: 'yellow',
    },
    {
    ...
    {
      label: 'Rejected',
      value: users.filter((u) => !u.approved && u.requestedRole === 0 && u.role === 0).length,
      icon: XCircle,
      color: 'red',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600 mt-1">Approve or reject role requests from users</p>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Users will appear here after they register</p>
              </div>
            ) : (
